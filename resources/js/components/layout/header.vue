            ...
            <div class="header-top">
                <div class="container">
                    ...
                    <div class="header-right">
                        ...
                        <div class="dropdown">
                            <a href="#language"><img src="/frontend_asset/images/flags/eng.png" alt="ENG Flag" width="14"
                                    height="8" class="dropdown-image" /> ENG</a>
                            <div class="dropdown-box">
                                <a href="#ENG">
                                    <img src="/frontend_asset/images/flags/eng.png" alt="ENG Flag" width="14" height="8"
                                        class="dropdown-image" />
                                    ENG
                                </a>
                                <a href="#FRA">
                                    <img src="/frontend_asset/images/flags/fra.png" alt="FRA Flag" width="14" height="8"
                                        class="dropdown-image" />
                                    FRA
                                </a>
                            </div>
                        ...
                        <a href="/frontend_asset/ajax/login.html" class="d-lg-show login sign-in"><i
                                            ...
                                            <ul class="megamenu">
                                                ...
                                                <li>
                                                    <div class="banner-fixed menu-banner menu-banner2">
                                                        <figure>
                                                            <img src="/frontend_asset/images/menu/banner-2.jpg" alt="Menu Banner"
                                            ...
                                            <ul class="megamenu">
                                                ...
                                                <li>
                                                    <div class="menu-banner banner-fixed menu-banner3">
                                                        <figure>
                                                            <img src="/frontend_asset/images/menu/banner-3.jpg" alt="Menu Banner"
                                            ...
                                            <ul class="megamenu">
                                                ...
                                                <li>
                                                    <div class="menu-banner banner-fixed menu-banner4">
                                                        <figure>
                                                            <img src="/frontend_asset/images/menu/banner-4.jpg" alt="Menu Banner"
                                                ...
                                                <li class="row">
                                                    <div class="col-6">
                                                        <div class="banner banner-fixed menu-banner5 br-xs">
                                                            <figure>
                                                                <img src="/frontend_asset/images/menu/banner-5.jpg" alt="Banner"
                                                    ...
                                                    <div class="col-6">
                                                        <div class="banner banner-fixed menu-banner5 br-xs">
                                                            <figure>
                                                                <img src="/frontend_asset/images/menu/banner-6.jpg" alt="Banner"
                                                                    width="410" height="123"
