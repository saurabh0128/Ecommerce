...
&lt;!-- Javascript --&gt;
&lt;script src="libs/datatable/datatables.min.js"&gt;&lt;/script&gt;</code></pre>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="demo-code-preview">
                    <pre><code class="language-html">&lt;table id="datatable-example" class="table"&gt;
  &lt;thead&gt;
    &lt;tr&gt;
      &lt;th&gt;Name&lt;/th&gt;
      &lt;th&gt;Position&lt;/th&gt;
...
&lt;/table&gt;</code></pre>
            ...
            <div class="card">
                <div class="demo-code-preview">
                    <pre><code class="language-js">$('#datatable-example').DataTable({
    responsive: true
});</code></pre>
                </div>
            </div>
