...
<div class="card m-3 ">
	<div class="card-body">	
		<div class="card-title text-center">Add Page Form </div>
			...
			<div class="row">
			    ...
			    <div class=" col-10 ">
			    	<div class="mb-3" >
				    	...
				    	<input type="text" class="form-control" id="page_name" name="page_name" value="{{ old('page_name') }}" autofocus  >
				    	@error('page_name')
					...
					<div class="mb-3 ">
						<label for="page_text" class="form-label">Page text* </label>
							 <textarea name="page_text" rows="5" cols="40" class="form-control tinymce-editor"></textarea>
						</div>
