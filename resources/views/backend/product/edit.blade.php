...
@section('css')
	...
	<!-- CSS -->
	<link rel="stylesheet" href="{{ asset('backend_asset/libs/tagsinput/bootstrap-tagsinput.css') }}" type="text/css">
...
<div class="card m-3 ">
	<div class="card-body">	
		<div class="card-title text-center">Edit Product Form </div>
		<form id="AddProduct" method="post"  action="{{ route('admin.product.update',$product->id) }}" enctype="multipart/form-data" >
			...
			<div class="row">
				...
				<div class="row">
				    ...
				    <div class="mb-3 col-12 ">
				    	...
				    	<textarea class="form-control" id="product_desc" name="product_desc">{{ old('product_desc',$product->product_desc) }}</textarea>
				    	@error('product_desc')
				    		<p class="text-danger">{{ $message }}</p>
				    	@enderror
				    </div>
				    ...
				    <div class="mb-3 col-12 ">
				    	...
				    	<textarea class="form-control" id="product_sort_desc" name="product_sort_desc">{{ old('product_sort_desc',$product->product_sort_desc) }}</textarea>
				    ...
				    <div class="mb-3 col-6 ">
				    	...
				    	<select name="Category" name="Category" class="select2-example" >
				    		...
				    		@foreach($categorys as $category_detail)
				    			<option value="{{ $category_detail->id }}" @if($product->category_id == $category_detail->id ) selected
				    			 @endif >{{ $category_detail->category_name }}</option>
				    		@endforeach
				    	</select>
				    	@error('Category')
				    		<p class="text-danger">{{ $message }}</p>
				    ...
				    <div class="mb-3 col-6 ">
				    	...
				    	@foreach($sellers as $seller_detail)	
				    		<option value="{{ $seller_detail->id }}" @if($product->user_id == $seller_detail->id ) selected @endif         >{{ $seller_detail->name }}</option>
				    	@endforeach	
				    	</select>
				    	@error('Seller')
				    		<p class="text-danger">{{ $message }}</p>
				    ...
				    <div class="mb-3 col-6 ">
				    	<label for="product_image d-block " class="form-label">Product Image</label>
				    ...
				    <div class="mb-3 col-12 ">
				    	...
				    	<input type="text" class="form-control tagsinput input-tag " id="seo_keyword" name="seo_keyword" value="{{ old('seo_keyword',$product->seo_keyword)}}" data-role="tagsinput" >
				    	@error('seo_keyword')
				    		<p class="text-danger">{{ $message }}</p>
				    	@enderror
				    </div>
				    ...
				    <div class="mb-3 col-6  ">
				    	...
				    	<div class="form-check form-check-inline " >	
					    	<input class="form-check-input" type="radio"  id="is_display_yes" name="is_display" value="0"
					    	  @if($product->is_display == 0 ) checked @endif >
				    ...
				    <div class="mb-3 col-6 ">
				    	...
				    	<div class="form-check form-check-inline " >
					    	...
					    	@if($product->is_avilable == 0 ) checked @endif >
				    	...
				    	<div class="form-check form-check-inline ">
					    	...
					    	@if($product->is_avilable == 1 ) checked @endif>
...
@section('js')
	...
	<script src="{{asset('backend_asset/libs/tagsinput/bootstrap-tagsinput.js')}}"></script>
