		...
		<form id="AddCoupon" method="post"  action="{{ route('admin.coupon.update',$coupon->id)}}"  >
			...
			<div class="row">
			    ...
			    <div class="mb-3 col-10 ">
			    	...
			    	<input type="text" class="form-control" id="coupon_code" name="coupon_code" value="{{ old('coupon_code',$coupon->coupon_code) }}" autofocus  >
			    	@error('coupon_code')
			...
			<div class="row">
			    ...
			    <div class="mb-3 col-10 ">
			    	...
			    	<textarea class="form-control" id="coupon_detail" name="coupon_detail">{{old('coupon_detail',$coupon->coupon_details)}}</textarea>
			    	@error('coupon_detail')
			    		<p class="text-danger">{{ $message }}</p>
			    	@enderror
			    </div>
			...
			<div class="row">
			    ...
			    <div class="mb-3 col-5 ">
			    	...
			    	<input type="text" class="form-control" id="coupon_discount" name="coupon_discount" value="{{ old('coupon_discount',$coupon->coupon_discount) }}"  >
			...
			<div class="row">
			    ...
			    <div class="mb-3 col-5 ">
			    	...
			    	<select name="coupon_type" id="coupon_type" class="form-select" >
			    		<option value="">Please select discount type</option>
			    		<option @if(old('coupon_type',$coupon->coupon_type) == "Product") selected @endif  value="Product">Product</option>
			    		<option @if(old('coupon_type',$coupon->coupon_type) == "Category") selected @endif value="Category">Category</option>
			    	</select>
			    	@error('coupon_type')
			    		<p class="text-danger">{{ $message }}</p>
			    	@enderror
			    ...
			    <div class="mb-3 col-5 ">
			    	...
			    	<input type="text" class="form-control" id="total_uses" name="total_uses" value="{{ old('total_uses',$coupon->total_uses) }}"   >
			    	@error('total_uses')
			    		<p class="text-danger">{{ $message }}</p>
			    	@enderror
			    </div>
			...
			<div class="row">
			    ...
			    <div class="mb-3 col-5 ">
			    	...
			    	<input type="text" class="form-control datepicker " id="start_date" name="start_date" value="{{ old('start_date',date("m/d/Y",strtotime($coupon->start_date))) }}"   >
			    	@error('start_date')
			    		<p class="text-danger">{{ $message }}</p>
			    	@enderror
			    </div>
			    ...
			    <div class="mb-3 col-5 ">
			    	...
			    	value="{{ old('end_date',date("m/d/Y",strtotime($coupon->end_date))) }}"   >
			    	@error('end_date')
			    		<p class="text-danger">{{ $message }}</p>
			    	@enderror
			    </div>
