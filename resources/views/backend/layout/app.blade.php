                    ...
                    <div class="dropdown-menu-body">
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <a href="#" class="me-3 flex-shrink-0 ">
                                    <img src="{{URL::asset('backend_asset/images/products/3.jpg')}}" class="rounded" width="60"
                                         alt="...">
                                </a>
                                <div>
                                    <h6>Digital clock</h6>
                        ...
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <a href="#" class="me-3 flex-shrink-0 ">
                                    <img src="{{URL::asset('backend_asset/images/products/4.jpg')}}" class="rounded" width="60"
                                         alt="...">
                                </a>
                                <div>
                                    <h6>Toy Car</h6>
                        ...
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <a href="#" class="me-3 flex-shrink-0 ">
                                    <img src="{{URL::asset('backend_asset/images/products/5.jpg')}}" class="rounded" width="60"
                                         alt="...">
                                </a>
                                <div>
                                    <h6>Sunglasses</h6>
                        ...
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <a href="#" class="me-3 flex-shrink-0 ">
                                    <img src="{{URL::asset('backend_asset/images/products/6.jpg')}}" class="rounded" width="60"
                                         alt="...">
                                </a>
                                <div>
                                    <h6>Cake</h6>
                ...
                <div class="card-body">
                    ...
                    <div class="summary-cards">
                        <div>
                            <div class="d-flex align-items-center mb-3">
                                <div class="avatar me-3">
                                    <img src="{{URL::asset('backend_asset/images/user/women_avatar5.jpg')}}" class="rounded-circle"
                                         alt="image">
                                </div>
                                <div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-custom mb-0" id="recent-products">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#">
                                        <img src="{{URL::asset('backend_asset/images/products/10.jpg')}}" class="rounded" width="40"
                                             alt="...">
                                    </a>
                                </td>
                                <td>Cookie</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#">
                                        <img src="{{URL::asset('backend_asset/images/products/7.jpg')}}" class="rounded" width="40"
                                             alt="...">
                                    </a>
                                </td>
                                <td>Glass</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#">
                                        <img src="{{URL::asset('backend_asset/images/products/8.jpg')}}" class="rounded" width="40"
                                             alt="...">
                                    </a>
                                </td>
                                <td>Headphone</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#">
                                        <img src="{{URL::asset('backend_asset/images/products/9.jpg')}}" class="rounded" width="40"
                                             alt="...">
                                    </a>
                                </td>
                                <td>Perfume</td>
