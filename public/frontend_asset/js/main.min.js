...
$.extend($.easing, {
                    ...
                    new IntersectionObserver(
                        function (e) {
                            for (var i = 0; i < e.length; i++) {
                                var o = e[i];
                                o.intersectionRatio > 0 && ("string" == typeof a ? Function("return " + functionName)() : a.call(t(o.target)));
                            }
                        },
            ...
            (Wolmart.Minipopup =
                ...
                }),
                {
                    init: function () {
                        ...
                        (a.className = "minipopup-area"), (e = t(a)), (this.close = this.close.bind(this)), (r = r.bind(this));
                    },
                    open: function (o, l) {
                        var c,
                            d = this,
    ...
    (function (t) {
        var e = function (e) {
            ...
            i = {
                init: function () {
                    this.initMenu(), this.initMobileMenu(), this.initFilterMenu(), this.initCollapsibleWidget();
                },
                initMenu: function () {
        ...
        var e = {
            init: function () {
                ...
                Wolmart.call(Wolmart.ratingTooltip, 500),
                    ...
                    Wolmart.$body.on("click", ".product:not(.product-select) , .product-popup .btn-cart, .home .product-single .btn-cart", function (e) {
                        e.preventDefault();
                        var a = t(this),
    ...
    (function (t) {
                    ...
                    : (a.$thumbs.removeAttr("style"),
                      a.$thumbs.hasClass("owl-carousel") ||
                          a.$thumbs
                              ...
                              .owlCarousel(t.extend(!0, a.isQuickView ? { onInitialized: i, onResized: i } : {}, e)));
            },
            i = function () {
        ...
        (ProductSingle.prototype.init = function (e) {
            ...
            (n.$wrapper = e),
                (n.isQuickView = !!e.closest(".mfp-content").length),
                (n._isPgVertical = !1),
                n.isQuickView && ((i = i.bind(this)), Wolmart.ratingTooltip()),
                s
                    .on("initialized.owl.carousel", function (e) {
                        document.body.classList.contains("home") ||
                            (n.isQuickView || s.append('<a href="#" class="product-gallery-btn product-image-full"><i class="w-icon-zoom"></i></a>'),
                            s.parent().hasClass("product-gallery-video") &&
                                (n.isQuickView || s.append('<a href="#" class="product-gallery-btn product-degree-viewer" title="Product 360 Degree Gallery"><i class="w-icon-rotate-3d"></i></a>'),
                                n.isQuickView || s.append('<a href="#" class="product-gallery-btn product-video-viewer" title="Product Video Thumbnail"><i class="w-icon-movie"></i></a>'))),
                            (function (e) {
                                (e.$thumbs = e.$wrapper.find(".product-thumbs")),
                                    ...
                                    a(e),
                                    Wolmart.$window.on("resize", function () {
                                        (e.thumbsIsVertical = e._isPgVertical && window.innerWidth >= 992), a(e);
                                    });
                            })(n);
                    })
                ...
                n.$wrapper.on("click", ".btn-wishlist", o),
                "complete" === Wolmart.status && (Wolmart.slider(s), Wolmart.initQtyInput(e.find(".quantity"))),
                n.$wrapper.find(".product-thumbs-sticky").length &&
                    ((n.isStickyScrolling = !1), n.$wrapper.on("click", ".product-thumb:not(.active)", n.clickStickyThumbnail.bind(this)), window.addEventListener("scroll", n.scrollStickyThumbnail.bind(this), { passive: !0 })),
                (function (e) {
            ...
            (ProductSingle.prototype.variationMatch = function () {
                this.$priceWrap.find("span").text("$" + (Math.round(50 * Math.random()) + 200) + ".00"), this.$priceWrap.slideDown(), this.$clean.slideDown();
            }),
            (ProductSingle.prototype.variationClean = function (t) {
                t && this.$selects.val(""), t && this.$items.children(".active").removeClass("active"), this.$priceWrap.slideUp(), this.$clean.css("display", "none") ;
            }),
    ...
    (function (t) {
        ...
        Wolmart.initProductSinglePage = function () {
            Wolmart.zoomImage(".product-gallery .product-image"),
                (function (e) {
                    var a = t(".product-sticky-content"),
